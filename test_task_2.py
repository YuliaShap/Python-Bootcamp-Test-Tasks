...
# assigning a variable with a path to a video using a VideoFileClip method
video_tiktok = VideoFileClip(
...
video_tiktok.write_gif("tiktok.gif")
# getting path to gif
print(pathlib.Path("tiktok.gif").parent.resolve())
